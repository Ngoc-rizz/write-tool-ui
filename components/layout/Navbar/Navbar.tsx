...
export default function Navbar({ onMenuClick, actions }: NavbarProps) {
  ...
  const handleThemeToggle = () => {
    if (theme === 'giay-nga') setTheme('giay-moc');
    else if (theme === 'giay-moc') setTheme('dem-than');
    else setTheme('giay-nga');
  };
    ...
    <header className={styles.navbar}>
      <div className={styles.left}>
        ...
        <Link href="/home" className={styles.logo}>
          ...
          <span className={styles.logoText}>Ink & Paper</span>
        </Link>
      </div>
      ...
      <div className={styles.right}>
        ...
        <Link href="/statistics" className={`${styles.navBtn} ${styles.hideOnMobile}`}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link href="/settings" className={`${styles.iconBtn} ${styles.hideOnMobile}`} title="Settings">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAuthenticated ? (
          ...
          <Link href="/login" className={styles.iconBtn} title="Log in" style={{ marginLeft: '8px', border: 'none', background: 'transparent', cursor: 'pointer' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
