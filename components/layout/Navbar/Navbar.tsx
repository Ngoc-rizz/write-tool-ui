    ...
    <header className={styles.navbar}>
      <div className={styles.left}>
        ...
        <Link href="/home" className={styles.logo}>
          ...
          <span className={styles.logoText}>Mực & Giấy</span>
        </Link>
      </div>
      ...
      <div className={styles.right}>
        ...
        <Link href="/statistics" className={`${styles.navBtn} ${styles.hideOnMobile}`}>
          ...
          <span className={styles.navBtnText}>Thống kê</span>
        </Link>

        <Link href="/settings" className={`${styles.iconBtn} ${styles.hideOnMobile}`} title="Cài đặt">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
